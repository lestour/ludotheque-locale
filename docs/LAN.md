...
- Les jeux compatibles proposent plusieurs formats selon leurs règles : coopération sur un état partagé, course sur des copies identiques, score collectif, versus individuel ou équipes alternées.
- En mode équipes, les sièges sont distribués alternativement entre deux à quatre équipes. Les actions partagées restent limitées aux partenaires et le classement additionne leurs scores.
- Dans les courses d’action compatibles, les positions sont envoyées au maximum huit fois par seconde et interpolées sous forme de silhouettes translucides. Ces données éphémères ne sont ni ajoutées aux replays ni conservées sur disque.
...
- Les puzzles partagés proposent coopération, course individuelle et équipes. Les jeux de score Arcade, Fusion 2048, Paires mémoire, Écho rythmique, Rhythm Lab et Karaoké proposent versus, score coopératif et équipes.
- Assaut Stellaire, Dérive Vectorielle, Chroniques de Poche et Flipper Nova utilisent la même graine et les mêmes options ; leurs départs, pauses et classements sont synchronisés, tandis que chaque appareil conserve sa simulation locale.
- Chroniques d’Asteria propose un monde partagé en coopération, une course sur des mondes identiques et des équipes. Les salles résolues, boss, objets principaux et énigmes à plusieurs dalles sont synchronisés.
